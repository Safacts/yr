"""
Django settings for yr_project project.
...
WSGI_APPLICATION = 'yr_project.wsgi.application'
...
'''
# This should be a list of directories where Django will look for static files
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]
