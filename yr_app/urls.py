...
from .views import homepage, products, search, upload, submit_product, product_list, password, search_products, all_products, order_button_click, delete_product, edit_product
